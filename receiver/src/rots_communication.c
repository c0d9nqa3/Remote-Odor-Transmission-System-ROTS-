 ...
 * @brief ROTS Communication Module
 * @author ROTS Team
 * @date 2024
 * 
 * Handles communication between ESP32 sender and STM32 receiver
 */
...
static void ROTS_Communication_UART_Callback(UART_HandleTypeDef *huart);
...
ROTS_StatusTypeDef ROTS_Communication_Init(void)
{
    ...
    // Configure UART for ESP8266 communication
...
/**
 * @brief Receive message from ESP32
 * @param message Pointer to message structure
 * @return ROTS_OK if message received, error code otherwise
 */
